...
<main className="form-sign-in">
    <form onSubmit={submitForm}>
        ...
        <div className="mb-3">
            <input type="email" className="form-control p-3 rounded-4" onChange={e => setEmail(e.target.value)}
             placeholder="name@example.com" value={email} required
             />
        </div>
        <div className="mb-3">
            <input type="password" className="form-control p-3 rounded-4"
        ...
        <center className="my-2">
            <button className="btn text-white fw-bold px-5 py-2 rounded-4 bg-dominant" type="submit">Sign up</button>
        </center>
    </form>
 </main>
    )
